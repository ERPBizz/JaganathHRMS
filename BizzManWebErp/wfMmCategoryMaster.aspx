                    ...
                    <div class="panel-body">
                        <table class="tbl">
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="text" style="width: 35%;" placeholder="Enter Category Name" class="form-control rounded border-dark" id="txtCategoryName" name="txtCategoryName" maxlength="200" />
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 11%;">Description</td>
                                <td colspan="3">
                                    <input type="text" style="width: 35%;" placeholder="Enter Description" class="form-control rounded border-dark" id="txtDescription" name="txtDescription" maxlength="200" />
                                </td>
                            </tr>
                        </table>
                    </div>
